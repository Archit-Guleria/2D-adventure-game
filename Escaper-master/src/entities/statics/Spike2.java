...
public class Spike2 extends StaticEntity {
    ...
    public Spike2(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.spike2, (int)(x - handler.getGameCamera().getXOffset()), (int)(y - handler.getGameCamera().getYOffset()), objectWidth, objectHeight, null);
