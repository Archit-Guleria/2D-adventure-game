...
public class Tree1 extends StaticEntity {
    private static int objectWidth = 250;
    private static int objectHeight = 210;
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.tree1, (int)(x - handler.getGameCamera().getXOffset()), (int)(y - handler.getGameCamera().getYOffset()), objectWidth, objectHeight, null);
        // Draw hitbox
