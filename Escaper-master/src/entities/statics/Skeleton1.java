...
public class Skeleton1 extends StaticEntity {
    ...
    public Skeleton1(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.skeleton1, (int)(x - handler.getGameCamera().getXOffset()), (int)(y - handler.getGameCamera().getYOffset()), objectWidth, objectHeight, null);
